...
class TelegramTabMixin:
    ...
    def _build_tg_tab(self) -> QWidget:
        ...
        # Colour comes from the active theme stylesheet (QLabel#tgFieldLabel);
        # never hardcode white here or the light theme becomes unreadable.
        lbl_srv.setObjectName("tgFieldLabel")
        lbl_srv.setStyleSheet("font-size: 12px;")
        ...
        lbl_port.setObjectName("tgFieldLabel")
        lbl_port.setStyleSheet("font-size: 12px;")
        ...
        lbl_secret.setObjectName("tgFieldLabel")
        lbl_secret.setStyleSheet("font-size: 12px;")
        ...
        lbl_link.setObjectName("tgFieldLabel")
        ...
        adv_hint.setObjectName("tgFieldLabel")
        adv_hint.setStyleSheet("font-size: 12px;")
        ...
        cf_hint.setObjectName("tgFieldLabel")
        cf_hint.setStyleSheet("font-size: 12px;")
